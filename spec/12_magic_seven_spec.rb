...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous number is 16' do
      it 'returns 12' do
        previous_step = 16
  ...
  describe '#divide_by_two' do
    context 'when the previous number is 12' do
      it 'returns 6' do
        previous_step = 12
  ...
  describe '#subtract_random_number' do
    context 'when substract random_number by itself' do
      it 'returns 0' do
  ...
  describe '#play' do
    context 'when the random number is 0' do
      ...
      it 'will return 7' do
        random_number = 0
        game = described_class.new(random_number)
        result = game.play
    ...
    context 'when the random number is 107' do
      # remove the 'x' before running this test
      it 'will return 7' do
        random_number = 107
        game = described_class.new(random_number)
